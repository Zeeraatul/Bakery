                ...
                <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary border-inner p-4">
                    <a href="index.html" class="navbar-brand">
                        <h1 class="m-0 text-uppercase text-white"><i
                                    class="fa fa-birthday-cake fs-1 text-dark me-3"></i><?= $data['options']['title']['value'] ?></h1>
                    </a>
                    <p class="mt-3"><?= $data['options']['description']['value'] ?></p>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-secondary mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Our
                                Services</a>
                            <a class="text-secondary mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Meet
                                The Team</a>
...
<div class="container-fluid text-secondary py-4" style="background: #111111;">
    <div class="container text-center">
        <p class="mb-0">&copy; <a class="text-white border-bottom" href="#"><?= $data['options']['title']['value'] ?></a>. All Rights Reserved.
            Designed by
            <a class="text-white border-bottom" href=""><?= $data['options']['author']['value'] ?></a></p>
    </div>
</div>
<!-- Footer End -->