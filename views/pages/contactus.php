...
<div class="container-fluid contact position-relative px-5" style="margin-top: 90px;">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <form method="post" action="/about/getClientMessage">
                    <div class="row g-3">
                        <div class="col-sm-6">
                            <input type="text" name="fio" class="form-control bg-light border-0 px-4" placeholder="ФИО" style="height: 55px;">
                        </div>
                        <div class="col-sm-6">
                            <input type="email" name="email" class="form-control bg-light border-0 px-4" placeholder="Your Email" style="height: 55px;">
                        </div>
                        <div class="col-sm-12">
                            <input type="text" name="subject" class="form-control bg-light border-0 px-4" placeholder="Тема письма" style="height: 55px;">
                        </div>
                        <div class="col-sm-12">
                            <textarea name="message" class="form-control bg-light border-0 px-4 py-3" rows="4" placeholder="Message"></textarea>
                        </div>
                        <div class="col-sm-12">
                            <button class="btn btn-primary border-inner w-100 py-3" type="submit">Отправить письмо</button>
                        </div>
                    </div>
                </form>
            </div>
